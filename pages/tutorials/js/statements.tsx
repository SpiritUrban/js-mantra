  ...
  const content: Content = {
    ...
    items: [
      ...
      },
      {
        subItems: [
          {
            subTitle: <>Функции с параметрами по умолчанию</>,
          },
          {
            subTitle: (
              <>
                Функции могут иметь параметры с значениями по умолчанию, если
                аргумент не передан.
              </>
            ),
            code: `
          ...
          },
          {
            subTitle: (
              <>
                ...
                <LiTags>
                  <li>
                    <Tag>&& </Tag>(И): возвращает <Tag>true</Tag> , если оба
                    выражения истинны
                  </li>
                  .
                  <li>
                    {" "}
                    <Tag>|| </Tag>(ИЛИ): возвращает <Tag>true</Tag>, если хотя
                    бы одно выражение истинно.
                  </li>
                  ,
                  <li>
                    <Tag>!</Tag> (НЕ): инвертирует логическое значение.
                  </li>
                </LiTags>
              </>
            ),
        ...
        subItems: [
          {
            subTitle: (
              <>
                Эти операторы позволяют управлять потоком выполнения кода,
                делать программы более гибкими и адаптируемыми под различные
                условия.
              </>
            ),
          },
